...
module.exports = {
  ...
  edgeToId: edgeToId,
  appendRectOverlay: appendRectOverlay,
...
/*
 * Inserts an overlay as the first child of the specified selection. This
 * overlay can capture all points events.
 */
function appendRectOverlay(selection) {
