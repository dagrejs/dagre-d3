...
function createEdgePaths() {
  ...
  var fn = function(selection, g, arrows) {
    ...
    svgPaths.selectAll("path.path")
      .each(function(e) {
        ...
        d3.select(this)
          ...
          .style("stroke-width", edge.strokeWidth || 1);
      });
    ...
    svgPaths.selectAll("defs")
      .each(function(e) {
        var edge = g.edge(e),
            arrowhead = arrows[edge.arrowhead] || arrows["default"];
        arrowhead(d3.select(this), edge.arrowheadId, edge);
      });
