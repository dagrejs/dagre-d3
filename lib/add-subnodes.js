  ...
  subnodesGroup.selectAll("g")
    ...
    .enter().append("g")
      ...
      .each(function(d, i) {
        ...
        if (d.tooltip) {
          const qcGroup = parent.select('g.subnode');
          const tooltipGroup = qcGroup.append("g").attr("class", "qc-tooltip");
          ...
          tooltipGroup.attr('transform', `translate(${-tooltipBBox.width / 2},0)`);
        }
      });
